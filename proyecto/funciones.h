...
/** Devuelve un número al azar de dados por jugador */
...
/**
 * @brief  Dibuja un cuadrado en pantalla
 *
 * @param x Posición a lo largo
 * @param y Posición a lo alto
